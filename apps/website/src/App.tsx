...
const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Yes. Both Mac and Windows installers are available now from the download button. A CA-trusted signature (to clear the SmartScreen prompt) is on the roadmap.",
  },
  {
    id: "damaged",
    question: "Mac says the app is “damaged and can’t be opened.”",
    answer:
      "That’s macOS Gatekeeper flagging an app that isn’t yet notarized with a paid Apple certificate — not actual damage. Easiest fix: skip the DMG and paste this one line into Terminal — it installs Rippopotamus and clears the flag for you:  curl -fsSL https://rippopotamus.vercel.app/install.sh | bash  (Already installed from the DMG? Run  xattr -dr com.apple.quarantine /Applications/Rippopotamus.app  instead. Apple notarization is on the roadmap so this goes away.)",
  },
  {
    id: "quality",
  ...
  },
  {
    ...
    answer:
      "No. Rippo is fully standalone. The download engine, ffmpeg, and aria2c are all bundled inside the app. Install it and go, nothing else to set up.",
  },
  {
    id: "failures",
  ...
  },
  {
    ...
    answer:
      "Rippo updates itself. When a new version ships, you get an in-app prompt to download and install it, then relaunch. No hunting for a new .dmg.",
  },
];
