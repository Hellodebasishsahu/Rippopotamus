...
const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "That’s macOS Gatekeeper flagging an app that isn’t yet notarized with a paid Apple certificate — not actual damage. One-time fix: open Terminal and run  xattr -dr com.apple.quarantine /Applications/Rippopotamus.app  then launch it normally. (Apple notarization is on the roadmap so this step goes away.)",
  },
  {
    id: "quality",
